#include "test_controller/vehicle_longitudinal_controller_pid.h"

#include <math.h>

#include <fstream>

#include "test_controller/common.h"

using namespace std;

static const rclcpp::Logger LOGGER = rclcpp::get_logger("test_controller_publisher");
    ...
    : Node("test_controller")
{
    ...
    // 读取参考线路径
    std::ifstream infile("src/l5player_controler/test_controller/data/2022_09_29_16_27_08_ins_data_map_after_preprocess.csv", ios::in); // 将文件流对象与文件连接起来
...
void VehicleControlPublisher::odomCallback(nav_msgs::msg::Odometry::SharedPtr msg)
{
    ...
    vehicle_state_.v = std::sqrt(vehicle_state_.vx * vehicle_state_.vx + vehicle_state_.vy * vehicle_state_.vy + vehicle_state_.vz * vehicle_state_.vz) * 3.6;
